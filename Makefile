...
obj_simon_64_32_core/Vsimon_core:
	verilator --Mdir obj_simon_64_32_core -cc simon_core.sv -exe tb_simon_core.cpp simon.cpp -O3 \
...
obj_simon_128_64_core/Vsimon_core:
	verilator --Mdir obj_simon_128_64_core -cc simon_core.sv -exe tb_simon_core.cpp simon.cpp -O3 \
...
obj_simon_128_128_core/Vsimon_core:
	verilator --Mdir obj_simon_128_128_core -cc simon_core.sv -exe tb_simon_core.cpp simon.cpp -O3 \
